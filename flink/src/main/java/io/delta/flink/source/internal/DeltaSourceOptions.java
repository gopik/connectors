 ...
 *
 * @implNote This class is used as a dictionary to work with {@link DeltaConfiguration} class
...
public class DeltaSourceOptions {
     ...
     * {@link DeltaConfiguration} using LOADED_SCHEMA_SNAPSHOT_VERSION option.
     * <p>
